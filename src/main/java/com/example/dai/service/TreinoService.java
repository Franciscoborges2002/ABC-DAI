...
import com.example.dai.repository.TreinoRepository;
...
public class TreinoService {
    ...
    public TreinoDto adicionarTreino(TreinoAddModel novoTreino){
        ...
        Treino treinoAdicionar = new Treino(novoTreino.getNomeTreino(), novoTreino.getEquipaTreinar(), novoTreino.getHorarioTreino());

        treinoRepository.save(treinoAdicionar);

        return new TreinoDto("Treino adicionado com sucesso!");
    }
